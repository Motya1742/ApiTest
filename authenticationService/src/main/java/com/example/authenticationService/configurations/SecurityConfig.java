...
public class SecurityConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        daoAuthenticationProvider.setUserDetailsService(userService::loadByUsername);
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authenticationProvider(authenticationProvider()); // Добавляем явный AuthenticationProvider
        return http.build();
    }
}
